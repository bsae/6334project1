...
public class OS extends Thread {
    ...
    public static CPU cpu = new CPU();//set to 10 to enforce FCFS/PS
    ...
    void FCFS() {
        ...
        while (Terminated_Queue.size() != totalProcesses) {
            ...
            if (Ready_Queue.get(0).programCounter % 2 == 0) {
                ...
                //loop through as many burst sequences and execute a bubblesort, update time, check if new->ready
                for (int i = 0;
        ...
        while (Terminated_Queue.size() != totalProcesses) {
            ...
            if (Ready_Queue.get(0).programCounter % 2 == 0) {
                ...
                for (int i = 0; i < c.timeslice; ++i) {
                    ...
                    //if reached timeslice, put into waiting queue
                    if (c.timeSliceRemaining == 0) {
                        Wait_Queue.add(Currently_Running.get(0));
                        Currently_Running.remove(0);
                    }
                }
